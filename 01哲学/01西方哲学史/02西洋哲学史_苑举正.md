...
- [ ] 「形式」与「材质」的结合。
- [x] Both the form and the matter are stressed.
- [ ] 从「潜在」到「实现」的过程。
...
>
> 我的解释和理解是，在当前的历史条件下，并在目前的一个小的时间段和空间段世界的秩序是给定的不变的，所以对于不超出这个时间段和空间范围的我们来说，这些general  statement，这些约定俗成，的是足够，也是唯一，是自明的与不变的。
...
这些knowledge【人不会忽然变老、人不会走着走着就飞起来】好像反应了一些自然的原则，但到底是不是自然的原则并不知道。归纳法有限制。黑天鹅事件。科学都是从约定俗成开始的，没有确定性。
...
经验由于具有普遍性，可以通过进一步的积累而达到可以被进一步经验检验的原则。
...
>为什么要通才教育而不是专才教育？
>
>从国家来说，教育是要挑选人才。而从个人来说，是要在适合的和喜欢的专业发展。但正
>
>是因为我们不知道我们适合什么，就通过分数来决定，难道就因为我们的分数高，就适合学医适合计算机（有可能这个人就怕血怕代码呢），那我们不通过通才教育通过什么呢能让学生选择合适的专业



关于社会科学方法论的问题

> 对于社会科学统计和数学化的现象【完全没有感觉的东西】，原来很有感觉的学科，社会、经济、政治变得没有感觉了。根据这个方法论，没有感觉才叫真正的学问，有感觉的学问不叫学问。跟亚里士多德的empirical tangible相违背【经验上的可感知性】，原有的现象内容就不见了。这样其实大家是对这些无感觉的东西没有兴趣的。
...
在这个论证中，如果假设命题p和q，那么其他不同于p和q的r，由于p和q的真理，必然地和演绎地遵循(先验分析24b 18-20)。
...
亚里士多德认为:1。推论的前提为真而结论为假是不可能的; 2 一个演绎必须有多个前提(“假设p和q”);

3 结论不可能与任何前提相同(不同于p和q);
...
4. 4.and that no redundant premises are allowed ('because of the truth of p and q').
