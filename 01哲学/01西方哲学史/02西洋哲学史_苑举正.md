...
>
> 潜在的potential，人去fully actualize完全实现，是一个过程【从potential到actualize慢慢实现吗，从潜在到实现的过程】
>
> 经验就是你仅有的【不谈knowledge，在经验上无知吗】。不去谈神秘的理念，无法验证的理念。
>
> 事物的起源要有一个基础
>
> 目的论。
...
>
> 而亚里士多德认为，我们都活在一个共同的经验世界中，当之为基础的，都是约定俗成的，所以我们要扩展我们的知识内容，期待跟别人不一样的想法。**所以受教育的目的，是为了创意**【很重要的人生哲学】。当我们活在一个固定的经验世界中，不吸收不突破不创新，忘掉了我们所生活的经验世界的基础是约定俗成的，是约定的，不是真的基础，既然是约定的，是经验的，就需要去实践突破【举例台湾的社会发展停滞】。
...
> 科学万能和科学不万能就是由于大家对于科学的错误认识导致的。科学不是绝对真理，只是当前历史经验下的总结归纳和演绎推理
>
...
> 中国的知识为什么经常停滞？我们没有批判理性的传统， 而是祖宗之法不可变
...
Aristotle's theory of demonstration, then, is not intended to 'describe' a procedure of scientific inquiry that begins from appearances; it is an 'account' of the knowledge that is achieved by successful inquiry.

亚里士多德的演绎理论，并不旨在“描述”从表象开始的科学探究程序；它是关于成功探究所实现的知识的“描述”。

Knowledge is to be claimed。

知识都是宣称的。

> 知识在柏拉图是无法获得的，是只有idea of  form。而在亚里士多德看来知识是宣称的

This process of justification, Aristotle claims, must be linear and finite 。

亚里士多德声称，这个证明过程必须是线性的和有限的。

> 避免知识的无限倒退和循环论证

A circular 'justification' must eventually 'justify' a given belief by appeal to itself, and an infinite regress imposes on us a task that we can never complete

一个循环的“证明”最终必须通过自身来“证明”一个给定的信仰，而无限回归会让我们承担一个永远无法完成的任务。

Since, therefore, neither a circle nor an infinite regress can really justify, a proper justification must ultimately appeal to primary principles of a science 

因此，既然循环和无限回归都无法真正证明，一个适当的证明最终必须呼应科学的基本原则。

These primary principles are ' assumptions ' ( *hypothesis* ); we must see that they are better known and prior to other truths of a science, without being derived from any further principles.

这些主要原则是“假设”（“假设”）；我们必须确保它们比科学中的其他真理更为熟知，且不是从任何进一步的原则得出的。

Since they are the basis of all demonstration, they cannot themselves be demonstrated; Aristotle claims that we have non-demonstrative understanding of the ultimate principles of each science 。

因为它们是所有证明的基础，所以它们本身不能被证明；亚里士多德认为，我们对每门科学的最终原理具有非证明性的理解。

>  non-demonstrative :所有的科学都是假设的状态经过证实，而这个证实是到目前为止被证实为真的存在。然而在我们当前的社会中，科学家和工程师他会以为他会以为他的工作是没有问题的。我们社会哪些强调科技与社会之间冲突的，强调风险的，强调对人危害的，强调伦理的，这些人的声音比较微弱，就是因为哪个相信科技万能的思想。

## 基础论

How are we entitled to claim understanding of an ultimate principle?

Aristotle believes that the principles of a science are reached from appearances (perceptual or dialectical or both), which are the starting points known to us

我们有何资格宣称理解最终原则？

亚里士多德认为，一门科学的原则是通过表象（感知或辩证或两者兼有）得出的，而这些表象是我们所知道的起点。

That demand suggests that the assumptions of a science must be self-evident .
It is claimed to be true without any inferential justification, so Aristotle's conception of knowledge expresses a foundationalist position

这种要求表明科学的假设必须是自明的。

它被认为是正确的，没有任何推理证明，因此亚里士多德的知识观表达了一种基础主义立场。

> 为什么要提出基础轮，你讨论到科学知识，一定要假设一个ultimate principles。如果你不假设这个基础，你在证明的过程中，只剩下两种方法，不是循环论证就是无限后退，完全 没有确定的东西。assumed  principles是ultimate的道理。把假设的基础当成一个假设的基础 ，把假设的基础当成一个假设的基础，然后开始才会有知识建构的可能。因为知识是claimed的。基础不是真的，基础是预设的。那它是不是很牢固呢？我们对于感官直觉能够有察觉外在世界的能力这件事情，是很巩固的基础。除此之外，你也没有了。
>
> 哲学家存在的目的，从建构中进行批判。对于亚里士多德而言，知识就是建构与评判，先建构然后评判，我们整个人成长的过程就是这个样子，因为你不可能不建构，因为那样你不知道怎么活。你活着就会觉得这种固定的操作模式，会感觉到不能满足你。所以你会再评判他。所以就是建构评判的过程。
...
亚里士多德谈的思维的方式，谈的逻辑，谈的语言哲学，谈的科学哲学，统统都是表现出**思维的方法决定了知识的内容的这个观念**。我们了解了这个方法，这个工具之后，就要来看这个世界。



我们生活的一切都在变化中

physics：就是改变，从潜在到实现的过程就叫做自然。physics强调改变的研究。

我们生活的一切都在变化中，在这个变化中什么是不变的，人类的意义在何处【实体的引入，substance】

> 蒋公存在吗？死了很久了。
>
> 他不在了吗？为什么，我们上课还用他举例子。 
>
> 所以他到底存在还是不存在呢。这个时候呢，语言所建构的世界是不受经验影响的。
>
> 你一个很亲的亲人，他如果过世了，你经常会觉得他存在。但你张开眼睛后发现，喔，刚刚是在做梦。但其实，他存在也不存在，经验上他不存在，tangible上不存在了。但是在memory中存在。所以再tangible还是存在。所以为什么说亚里士多德，在他的形而上学中强调物理学，要强调substance的概念，就是要强调一个最终极的一个存在的意义。 他是不受经验影响的。



## 1 从逻辑到改变

对于亚氏而言，部分逻辑的功用，在于解释「述词」的本质 predication ( ' A is B ' , analyzed by Aristotle as ' B is predicated of A ' or ' **B belongs to A** ' as in ' **animal belongs to every man** ' (such that ' man is animal ' ) 。这是逻辑所隐含的预设。

> predication ：断定；声明；谓项
>
> B是修饰A的，苏格拉底**是**人，人是修饰苏格拉底的，so苏格拉底是第一实体，种属是第二实体。
>
> 是subject  includes the  predicated ;
>
> 苏格拉底是人；苏格拉底是男人；苏格拉底是哲学家；苏格拉底是雅典人；苏格拉底被predication的方式有很多种。主词有无限多种可能，这些可能包含了各式各样的描述的词，而述词本身来讲都是general term，但是单独一个object怎么会包含许多general term的问题?

为了述词，亚氏提供了十种范畴。 Categories ( *kategoriai* ; usually called *schēmata tēs katēgorias* *）*

> 除了实体【ousia】之外，其他都是形容词或名词，可以作为被叙述就是predicated。
...
>
> 对于国际新闻有没有兴趣，完全看你个人脑袋当中。有没有一个已经有pre-established的framework来吸收这个国际知识。所以类似，经济学框架、政治学框架也是类似的。
>
...
' Socrates is a man '与' Socrates is a musician ' 是文法一样，但却「指涉」不同事物。
The first predicates a second substance of a first substance, whereas the second predicates a non-substance of a first substance
第一个谓词是第一个实体的第二个实体，而第二个谓词是第一个实体的非实体

> 从这两个区别，可以说世界是说出来的，
>
> 百善孝为先有没有物质基础？用最严格的物质基础来讲，所有的这种抽象概念都是没有基础的，如果百善孝为先不是绝对正确的，那么万恶淫为首也就不一定是真的恶啦，这都是概念的运用，互相指淫荡，其实人没有淫不淫荡不荡的问题，都是说出来的。
>
> 对于亚里士多德来讲，因为世界是我们说出来的，换成我们会这样子叫他这个名称，大家有共同的印象，会有general term共同印象，你讲什么就是什么，就使得我们语言跟世界连在一起，如果语言跟世界连在一起的话，我们就只有存在状态的讨论，没有属于经验内还是经验外的讨论。比如特洛伊战争为什么会变成历史，故事为什么就是历史，story为什么就是history【亚里士多德出现的三个困扰，第一 前提为假，结论为真是不成立的；predicate，人属于苏格拉底很难理解；我们在语言里面讲的通通是真的】substance是超越经验的，就是我们一般人如果没有这样子一个哲学思维说，我们的世界是经过语言所建构的话，我们就处处以经验内跟经验外做区分，我们会觉得《三国演义》跟《三国志》不一样 ，如果世界是用语言表达出来的， 这个存在的状态，我们所表达的对象，他本身经验内经验外不是重点，因为经验本身不是一个真假的诉求，经验本身是很难讨论的东西。我们所有用语言描述出来的世界，就是这个世界的存在状态。比如，刚刚讲到，不管多不可能的事情，阿拉丁神灯坐着飞毯跑来跑去，哈利波特拿着扫把飞来飞去，圣诞树的礼物是圣诞老公公放在烟囱里的，真的假的？以经验作为一个真假认定的标准，是一件很困难的事情。这很困难的事情表现出来居然是一件在平常不过的事情。
>
> 所以要预设一个substance出来，这个substance是超经验的。因为经验不足以作为能够作为一个真假判断。你讲的是什么就是什么，predicate只有主词和predicate之间的关系。

> puti:语言里面讲的通通是真的【巴门尼德 思维 语言 存在三者是同一的】，思想和言说的都是抽象概念，他们不依赖于经验世界的情况，也不依赖于物质世界。



对于亚里士多德来说，思维，存在，言说三者的关系，请分析；并和巴门尼德的思想做对比？-gpt

>亚里士多德认为，思维、存在和言说三者之间存在着密切的关系和依存关系，彼此相互作用。他认为存在是思维和言说的前提和基础，思维和言说相互促进，言说必须基于存在。这一立场可以用他的思辨哲学中的形而上学和逻辑学来解释，其中逻辑学揭示思维的过程，形而上学研究存在的实质和属性，使得三者之间存在密切的联系。例如，当我们思考一个概念或者一个物体时，我们必须首先认识它的存在，并了解它的特点和属性，才能进行深入的思考和理解。
>
>而巴门尼德则强调存在与言说之间的关系，而不是思维。他认为，存在是由言说构建的，而非反之。换句话说，语言不是用来描述真实存在的客观事实，而是用来建构和塑造人们对世界的看法和认知。因此，言说是至关重要的，它不仅反映出我们对现实的看法，还塑造了我们对现实的观念和认知。他的观点主要体现了言语哲学，即言说、符号和意义之间的关系。
>
>两位哲学家对于思维、存在、言说三者的立场有所不同。**亚里士多德更注重思维和存在的联系，言说则是思维和存在的表达方式，而巴门尼德则认为言说是存在的基础??，是塑造人们对世界认知的关键。**



>亚里士多德认为思维、存在和言说三者的关系是密切相关的。他认为思维是思考的能力，言说是表达思维的能力，而存在是思维的对象。亚里士多德从逻辑学、形而上学和语言学三个方面探讨了这三者之间的关系。
>
>从逻辑学的角度来看，亚里士多德认为思维是逻辑推理的过程，言说则是用语言来表达推理的结果，而存在则是逻辑推理的前提和结论。思维、存在和言说是逻辑学三个方面的主要对象。
>
>从形而上学的角度来看，亚里士多德认为存在是在物质世界中的事物，包括自然物体和人类文化等，而思维则是人类的智力能力，言说则是人类交流的一种形式。从这个角度来看，思维、存在和言说三者的关系，可以理解为思维和言说是在存在的基础上展开的。
>
>从语言学的角度来看，亚里士多德认为存在是通过自然语言来表达的，而思维则是通过语言语言的语法和逻辑规则来描述的。言说则是通过语言来交流思想和概念。通过这种方式，语言成为了人类思维和存在之间的桥梁。因此，亚里士多德认为思维、存在和言说三者是密不可分的，并相互依存的

霍尔贝格奖 holberg奖



第一范畴是「实体」 *ousia* (literally, ' being ' )，在拉丁文中是' *substantia* '，所以以' substance '称之。

其他范畴中重要的是质、量、与关系。

> 总有一个东西是被描述的对象，代表他的subject然后来进行描述。



每一种范畴都有殊象与共象。 

The statement that' this individual man is an animal ' predicates a second substance (that is, a universal in the category of substance) of a first substance (that is, a particular in the category of substance).

“这个个体的人是一种动物”这句话，就把第一实体(即物质范畴内的一种特殊物质)的第二种实体(即物质范畴内的一种普遍物质)作为谓语。

' White is a colour ' predicates one universal quality of another.

“白色是一种颜色”断言了另一种普遍的性质。



范畴显现存在的复杂性，但亚氏认为这是称呼上的不同。从这点可以知道，亚氏的存有学与逻辑语言之间的相关性。连带地这也使得存在不是一个固定的范畴。
...
- [ ] Aristotle believes Plato mistakenly pursued a single account of beings; the theory of categories is meant to avoid Platonic errors.
- [ ] 亚里士多德认为柏拉图错误地追求对存在的单一解释;范畴论是为了避免柏拉图式的错误。

>社会科学为什么是科学，如果了解科学的起源的话，我们对所有的事物，重点是我们的经验决定了科学的内容。而不是对象。



前者认为真实存在就是型式【理型】的，而后者认为真实存在就是形式与材质的结合。 

对于柏氏而言，存在就是理型的显现。对于亚氏而言，存在就是范畴的指称。
...
但是对于亚氏而言，指称、范畴与存在三者之间，有一个共生关系。

这是一个预设立场。

> 指称是我们命名的 过程，范畴是我们按照我们归纳后的结果。把他分类，分类后的结果就是真实存在。
>
> 分类系统是活的。熊猫是属于熊还是属于猫，还是单独一个种，都可以。分类系统是活的。分类系统完全来自于经验的。界门纲目科属种是天生的，还是约定俗成的？。经验本身是活的。



## 2 改变与实体

亚氏物理学讨论的是「自然」，其实是动态的发展，展现本质的过程，包含一切事物。

- [ ] The nature of x is a principle (or ' source ' ; *archē* ), internal to x; hence the inquiry into nature leads to a discussion of change in natural substances
- [ ] x的本质是一个原理(或“源”;Archē)，在x内部;因此，对自然的探究引出了对自然物质变化的讨论

------



亚氏在理解变化所引用的观念是辩证的。例如，人的成长需要持续的转变，但总是在一个内在原则的引导下发生各种转变。这个内在原则的认知，是融贯的。

- [x] presupposed by a coherent account of natural change .
- [ ] 以自然变化的连贯叙述为前提。

> 人的成长是一个辩证的过程，经验论也是一个辩证的过程。
>
> 1 学生学会发问   2 学会说理  3 要有自己的想法  4 要有实现人生目的。在大学四年中，一定要做好放手一搏的准备。不要到了毕业迟迟不敢尝试人生。因为只有在错误或成功中才能够学习下一步。不管是成功也好还是错误也好，是必要的一步。因为人的发展是一个辩证的过程。有很多人就迟迟不愿意做一个选择。你一不做选择，你就停在哪儿。

对于一个人的改变而言，主体本身就是唯一不变的存在，也就是「实体」的范畴。

「实体的改变」，就不算是改变，而是消失。

- [ ] Socrates ' ceasing to be a man is not a change in Socrates, but the perishing of Socrates.
- [ ] 苏格拉底不再是一个人并不是苏格拉底本身的变化，而是苏格拉底的消逝。

------

实体，因此而成为本质。

These essential properties define a kind to which the first substance belongs.

其他九种范畴都不是实体的，所以其在语句中的意义与在存有学中的存在都不一样。

------

即使消失，实体也可以继续存在，就像是「一块青铜」消失后，成为一个雕像。

这里的变化是，从材质，转向形式【铜变像】

------

这个观念中似乎包含只有材质才是真正实体的感觉。

- [x] The genuine substance , is the matter , whereas the apparent substance (for example, the statue) is simply matter with a certain shape.
- [ ] 真正的实质是物质，而表面上的实质（例如雕塑）只是物质具有一定形态。

-------

一个自然存在物也可能是由材质与形势所结合出来的结果。

- [x] Similarly, then, a natural organism might be understood as a piece of matter shaped in a certain way so as to embody Socrates.
- [ ] 同样，一个自然生物可以被理解为一块以某种方式塑造的物质，以体现苏格拉底。

------

- [x] Natural organic ' substances ' , such as Socrates and this tree, turn out to be not genuine subjects, but mere configurations of the matter that is the real substance 。
- [ ] 像苏格拉底和这棵树这样的天然有机“物质”，实际上并不是真正的主体，而只是构成真正的实质的物质的形态。

> 什么是实体？什么是真实的存在。这都是需要讨论的问题。到底强调是质料还是形式

------



经验世界和语言的世界，经验世界是有限的，而语言的世界是无限的。

> 亚里士多德非常重要的地方是，他把整个世界透过我们语言和世界的关系，指出哪个融惯的系统，因为我们不单单是在经验中看到了这个世界，我们的语言也描述了这个世界。我们在经验中所描述出来的世界跟语言描述的世界有一个很大的差别，我们语言是一种无限的表达方式，而经验可感知的部分是有限的，所以无限跟有限之间就形成了很大的差距。这个差距对于亚里士多德来说，**这个差距不要走的太遥远**。换而言之，亚里士多德的哲学是科学性【因为语言的差距和经验感官世界不是很遥远】，希望能把经验的内容作为一个本。语言的表述搭配这个经验内容。so，整个世界呢，求知的，知识的定义了，就在整个融惯的系统中了。但是那一部分是我们不能通过经验只能通过语言描述的呢。change，ontology，meatphysical questions.这些都是你看不到的东西，但是在你的思想中，语言中可以问的问题。我们的心灵状态突破了我们的经验。但是他的突破不能太遥远，必须要拉回来。我们现在一直在亚里士多德的基础上做哲学上的修正。我们没有办法离开亚里士多德的这个问题，就是我们经验到底准许我们做出什么样程度的推理【胡塞尔的现象学说的比较好】。



融惯系统

> 亚里士多德的整个系统是一个融惯的系统，在逻辑学中，逻辑、理性、语言的时候， 指称，语言的表达讲出这个世界，世界的规则代表我们知识的可能性，所以有了知识论，有了科学哲学以及语言哲学的架构【逻辑学是工具，用逻辑学去解释变化、灵魂、和其他的东西】。有了这个架构后，我们探讨的第一个问题是，物理世界中的改变是如何来的。然后，语言告诉我们，这些改变是一个分类的结果，什么是使得这一切分类成为可能【本来他不是这样子的，后来变成这个样子，他会改变】，解释完这些问题后，你要问的问题就是他改变的理由，你能不能解释为什么为什么它是这样的【why question】。
...
> 来大学的第一件事情，就是学会发问。
>
> 发问有两个固定的格式，一个是别人陈述的逻辑性，因果链；
>
> 第二个问题：你发问时会遇到一个问题，即你发问对象的权威。
>
> 对于亚里士多德而言apodexis，demostration，causal explanation，
>
> demostration的这个理缺一不可，这个demostration展示的道理是让人发言最重要的勇气。

亚里士多德告诉我们，任何的问题，只要你问出了why question？就有哲学的意涵在里面。

proper name 合适的名字

三个人在谈论学生运动，两个人谈论的很激动。一个人说你们讨论的是一个空的东西。因为学生甲只是上街，学生乙只是举了一个横幅，都是在做一个具体的事情，为什么说是学生运动呢。

语音【单词 term】跟这个东西构成一个object的那个关系，是亚里士多德在经验主义中解决的，换句话说我们要讨论任何一个事物，其中要有建立这样心里的一个共识【很多分歧、争论的源头就来自这儿】我们要知道，我们共同要知道，我所指的那个事情，是什么事情【即定义】，然后给哪个事情取个名字。这个名字是不是符合这个定义，还是指涉的，还是想象的，并没有那么重要。我们是一个融惯性质要讨论的东西。亚里士多德讲到语言哲学的时候，我们对一个object， 要达到共同认知。对于亚里士多德而言，他的每一个系统中的步骤都非常清楚。然后我们才可以坐下来讲说，针对于一个东西说，说他是什么，问一个东西why  question。

> 要问why  question的前提，是在约定俗成的陈述上进行的。是在类中，在名中，在共相中进行的，而不是陷溺于一个一个具体的存在物中。因为只有了约定俗成的陈述，我们才可以得以理解这个世界，可以有在这个约定俗成的世界中有疑惑。如果没有共识，那所有人的世界都只是“寂”，无规则规律，就更不要谈问题和发问了。
>
> > 而我们所有认知的物，也只是经过人的主体参与所形成 的“物”或者说“事物”，我们是活在“物”与“物”中，活在人与“物”中，活在人与人中，而不是活在哪个完全独立的物自体的世界中，所以在这样的一个“物”的世界中，可以说是心外无物，心外只是存在着的无，心外只是“寂”。所以王阳明说“你未看此花时，此花与汝心同归于寂.

把问题问出来是一个很困难的事情。为什么困难呢？

你之所以能把他当做一个对象【能把他叫出来】，是因为你经验上要有所与的内容，而你经验上所与的内容不一定以感官知觉为限，你可以想到一个传承的理念【比如：学生受到左派思想的影响以至于以为透过大型的社会运动，可以达到他们所诉求的目的】这句话，全部是形而上学的，“左派思想的影响”，“社会运动”，“诉求的目的”都是not tangible，这种经验上不可以感受到的东西，可以伴随着经验的延伸再延伸【比如记忆、意识、概念、理念、甚至于想象和创意】。所以亚里士多德的why question？，是指一切事物的可能性【不仅仅是感官上的事物】，可以对一切事物问question【苑老师说，他离开教室的时候，他的眼睛像亮了一样 i am illuminated】。

What's the cause making this chair coming into being?当问这个问题的时候，哪个chair不是重点，重点是整个发问的方式【重点是可以发问】。任何事物灵魂鬼怪都可以问，why, why are you so afraid of ghosts[为什么怕鬼]?这根本就是鬼话吗。Why are you so afraid of market。



why雕像？

> 1 什么材质做的。意大利产的大理石。【质料因】
>
> 2 按照什么形式做的。按照圣经里面所描述的David做的【David打垮独眼巨人】。【形式因】
>
> 3 谁雕的。米开朗琪罗 。他是efficent让他存在 【有效因】
>
> 4 他的目的是什么。让人永远记住，这个人的伟大。 【目的因】
...
在逻辑学部分中讲到了逻辑和理性、语言。指称、语言的表达讲出这个世界【形式逻辑范畴就是世界的本质】，世界的规则规律代表我们知识的可能性，所以有了语言哲学、科学哲学和知识论的语言架构。然后讨论物理世界的改变是如何来的，然后语言告诉我们这个世界的改变是分类的结果【十个范畴-分荀子】，然后解释什么使分类成为可能。什么使分类成为可能，他本来不是这样子，后来变成这个样子，他会改变。解释完改变之后，你要问改变的理由。改变的理由，就是你能不能解释他为什么是这样。换言之，why quenstion？--大学是学会发问。

> 发问---有的格式的--
>
> 1 别人的论述中，哪一部分缺乏因果解释【亚里士多德的英国相连性】
>
> 2 伦理学的部分：发问的勇气的问题-说的跟学的人的权威的问题。好多人不敢发问。demonstration【证明】是让人发言的最重要的勇气。我们通常只想到logical  connection，没有想到叫别人将所有的cause  link说出来，是检讨人与人之间思考深度的问题。一再强调，苏格拉底并没有教跟学的关系【很重要很重要对我来说】。亚里士多德实现了苏格拉底的辩证精神-“有理行遍天下，无理寸步难行”的哪个理就是自然推理的结果。
>
> 注意【理与权威】：权威的时代过去了。你还是用权威回答，那完全没用。你要用科学来回答。除了数学，什么都可以挑战。【the authority of mathematics】。因为数学能力是神给的。
>
> 柏拉图和亚里士多德的很大区别：数学是天赋的，是神给的，是不能用知识论去证成的-神秘性。而亚里士多德说经验中的所有东西都是可以证成的【实在论realism】。

**解释理论用来回答「为什么？」**

' Why does this event happen? ' or ' Why is this object as it is? ' , we state the **cause** (or **explanation** ; aition ) of the event or object.

Aristotle believes that causes are multivocal （多重的） .
...
三个人在谈论“学生运动”，两个人谈论的很激动。一个人说你们讨论的是一个空的东西。因为学生甲只是上街，学生乙只是举了一个横幅，都是在做一个具体的事情，为什么说是“学生运动”呢。
...
苑老师说，报纸上的事他只要看懂了，对任何一件事情，他马上有不同的问法。因为一件事有两个层面，一个是rhetoric【修辞式的】，另外一个是推理式的，针对数学权威【推理】是不能挑战的，可是一种修辞式的权威 是可以挑战。

> 正是因为名是约定俗成的，而不是绝对的客观的，所以中间就有空间，有腾挪的地步。比如你说“古代四大文明只有中国的文明留存了下来”，这些里面都有非常多的约定俗成的general statement；比如说“近代史的开端”，何谓“近代史”，何谓“开端”，这里面是rhetoric。所以近代史的开端有很多种说法。

What's the cause making this chair coming into being【椅子哪儿来的】?当问这个问题的时候，**哪个chair不是重点，重点是整个发问的方式**【重点是可以发问】。任何事物灵魂鬼怪都可以问，why, why are you so afraid of ghosts[为什么怕鬼]?这根本就是鬼话吗。Why are you so afraid of market。

> 所以亚里士多德的四因说，物理学的原因是建立在逻辑学上，在立在经验主义上的。要可以发问的前提是这个世界是一个约定俗成的融贯的世界。
>
> > 或许每个人都有惊异有好奇，比如“雷电击中树木着火”这种现象，但是人要问“”“雷电击中树木着火”“”，这需要约定俗成，需要积累，需要语言，需要共识。而要问“why, why are you so afraid of ghosts[为什么怕鬼]”，“学生受到左派思想的影响以至于以为透过大型的社会运动，可以达到他们所诉求的目的”这种偏形而上的问题，则更需要时光和前辈先贤的努力。

Aristotle believes that causes are multivocal    亚里士多德相信原因是多重的。

Different accounts of a cause correspond to different answers to why-questions about (for example) a statue.

关于原因的不同描述，对于（例如）关于一座雕像的“为什么”问题，会有不同的答案。

------

(1) 物质因' It is made of bronze ' states the  material cause .

(2) 形式因' It is a statue representing Pericles ' states the formal cause , by stating the definition that says what the thing is.

(3) 有效因' A sculptor made it ' states the ' source of change ' by mentioning the source of the process that brought the statue into being; later writers call this the ' moving cause ' or ' efficient cause ' 

谁做的-哪个工匠做的。

(4) 目的因' It is made to represent Pericles ' states ' that for the sake of which ' , since it mentions the goal or end for the sake of which the statue was made; this is often called the ' final ' (Latin finis ; ' end ' ) cause .为了干什么。

它是由青铜制成的，这说明了它的物质原因。

“它是一座代表伯里克利的雕像”，通过说明定义从而说明这一事物的形式原因。

“一个雕刻师制作了它”，通过提到带来雕像的过程中的源头，来说明“变更源”，后来的作者称之为“移动原因”或“有效原因”。

“它是为了代表伯里克利而制作的”，提到了雕像制作的目的或终点，因此说明了“为了的原因”，这通常被称为“终极”（拉丁语finis，意为“终点”）原因。



亚里士多德的why question?不必是全称式的。经验中可以出现例外的。这和柏拉图不同。柏拉图是没有例外的。亚里士多德的思想有例外【比如三角形的例外】
...
Sometimes (as in our example) a complete answer requires all four causes.

------

三角形的特例： Not all four, however, are always appropriate; the (universal) triangle , for example, has a formal cause, stating its definition, but no efficient cause , since it does not come into being, and no final cause , since it is not made to promote any goal or end.

然而，并不是所有四种原因都适用；例如，（普遍存在的）三角形有形式原因，说明它的定义，但没有有效因，因为它并没有产生，而且也没有最终原因，因为它并不是为了达成任何目标或终点而制造的。

------

- [x] A hammer ' s form and essence is a capacity to hammer nails into wood.
- [ ] 一把锤子的形式和本质就是将钉子敲进木头的能力。
- [x] The hammer was designed to have this capacity for performing this function; and if this had not been its function, it would not have been made in the way it was, to have the properties it has.

- [ ]  锤子被设计成具有执行这一功能的能力；如果这不是它的功能，它就不会以它目前的方式制造，具有它所拥有的属性。

------

**形式因为指出功能而解释存在的原因。**

- [x] The form includes the final cause, by specifying the functions that explain why the hammer is made as it is.
- [ ] 形式包括最终原因，通过指定解释为什么锤子是制成这样的功能来说明。

------

**对于自然存有物而言，形式因【form cause】解释其所有的功能，也构成其存在的目的。** 

- [ ] The parts of an organism seem to perform functions that benefit the whole (the heart pumps blood, the senses convey useful information).
- [ ] 生物体的各个部分似乎执行有益于整体的功能（心脏泵血，感官传输有用信息）。

> 亚里士多德的系统，起点是思想，终点是政治。political science is the highest science 政治是最高的科学。
>
> 我们对于一个东西最在意的是，这个东西是什么，还有我们为什么要这个东西。一个形式是决定他的功能和存在的目的。
>
> ex：教育是功能什么？我们为什么要受教育。受教育的终极目标是什么。形式决定了他的功能和目的。
>
> 形式本身反过来由事物的行为所决定，因为这些行为都是以实现目的因为主。

------

**形式本身反过来由事物的行为所决定，因为这些行为都是以实现目的因为主。** 

- [x] The form of an organism is determined by the pattern of activity that contains the final causes of its different vital processes.
- [ ] 一个生物体的形式是由包含其不同重要过程的最终原因的活动模式所确定的。

> 形式因很重要。
>
> 天有天的形式，地有地的形式，人呢？人有没有人的形式
>
> 外在形式：眼睛，鼻子，耳朵
>
> 内在形式：向上向善？？【内在本质，追问人究竟有没有内在本质。绝对主义和相对主义的问题。亚里士多德认为有内在的形式，而存在主义认为存在先于本质。人的本质是生成的。】人的本质是不是先天的，还是后天生成的。
>
> 形式决定了我们到底要做什么，应该做什么，因然的问题。

------

所以，对于亚氏而言，形式与材质都对于存在扮演了重要角色。

Hence Aristotle believes that form as well as matter plays a causal role in natural organisms.

> 形式与物质的结合并不是偶然的，因为哪个形式决定了发展的方向
>
> 对于人来讲，人的形式就是灵魂。你形式的部分就是你应该拥有的部分

------

**亚氏的融贯系统中，解释这些并不是他所需要证成的部分；它们都是预设的。**

- [ ] He does not say, for instance, either(1) that organisms are the products of intelligent design (as Plato and the Stoics believe), or (2) that they are the outcome of a process of evolution .

- [ ] 他没有明确表态，例如，(1)认为生物体是智能设计的产物（正如柏拉图和斯多儿学派所认为的那样），也没有(2)认为它们是一种进化过程的结果。

  > 他不会诉诸于神学，也不会诉诸于evolution 
  >
  > Thy way I see you is either crated by God or is evolved,the result of evolution 现在我们对于这个世界的两个常见的看法是进化论和神创论。
  >
  > 亚里士多德是第三种？？

------

- [x] Aristotle does not say much more than what he considered to be ' causal explanation ' .
- [ ] 亚里士多德只是阐述了他认为的“因果解释”，并没有过多论述。 
- [x] He looks into the nature of things by offering a coherent explanation without further ado.
- [ ] 他通过提供一个连贯的解释来研究事物的本质，没有做更多的解释。
- [x] Further ado would cause the bifurcation of creationism and evolutionism.
- [ ]  进一步的解释可能会导致创造论和进化论的分裂。

------

## 4 从潜在到实现的转变

自然就是因内在原则（形式」而转变。**这是一个从潜在到实现的过程。**

- [ ] Aristotle studies **nature as an internal principle of change and stability** ; and so he examines the different types of change (or ' motion ' ; kinēsis ) 
- [ ] 亚里士多德研究自然作为变化和稳定的内在原则；因此，他研究了不同类型的变化（或者“运动”；kinēsis）。

> 潜在到实现是一个过程
>
> 对事物的理解，重点不是一个固定的状态。而是一个变动中的状态。你用一个固定的状态去看待一个事情，你完完全全会误解。ex：现在学生到底在想什么，你不应该这样问，而应该问，整个历史过程的发展到今天，让我们学生脑袋想这些东西的理由是什么。所以，后来，卢梭谈到人类不平等的起源，到尼采谈到人类道德的谱系，黑格尔的精神现象学。通通都是用的geneology，要在历史的辩证中，人类所有的活动都是一个完完全全在历史中变动，逐渐逐渐到今天。所以，今天的结果，最早就已经决定了。生活中的每一个片段，都是整个历史中的一部分。我们所有这个历史整个阶段合起来，是我们要从事的一切事物的终极原因。我们要面对历史，因为一个人没有历史感， 就不会真的理解一个事情。亚里士多德的从潜能到实现，他的每一个理念都构成了后来哲学发展的重要一部分。
>
> ex：你看到一个外卖员骑着骑着车忽然傻傻的就哭了？你不能说一个大男人什么都没遭受就忽然哭了，而应该去看他之前都遭受了什么。



------

- [ ] His definition marks the importance of his views on potentiality (or ' capacity ' ; dynamis ) and actuality (or ' realization ' ; energeia or entelecheia ) 

- [ ] 他的定义标志着他对潜力（或者“容量”；dynamis）和实际（或者“实现”；energeia或entelecheia）的看法的重要性。

  > 因为这个才会有教育的概念

------

The primary type of potentiality is a principle ( archē ) of change and stability.

If x has the potentiality F for G, then 

(1) G is the actuality of F, and

(2) x has F because G is the actuality of F.

潜能的主要类型是变化和稳定的原则（archē）。
...
Marathon runners, for instance, have the potentiality to run 26 miles because they have been trained to run this distance; hearts have the capacity to pump blood because this is the function that explains the character of hearts.

例如，马拉松选手有跑26英里的潜力，因为他们接受过这个距离的训练；心脏有泵血的能力，因为这是解释心脏性质的功能。

In these cases, potentialities correspond to final causes     ( eventually, or after the process of growth ).

在这些情况下，潜力对应目的因（最终，在生长过程之后）。
...
Potentiality and possibility do not, therefore, imply each other .

(1) Not everything that is possible for x realizes a potentiality of x. Perhaps it is possible for us to speak words of Italian (because we recall them from an opera) without having a potentiality to speak Italian (if we have not learnt Italian).

(2) Not everything that x is capable of is possible for x; some creatures would still have a potentiality to swim even if their environment lost all its water.

因此，潜力与可能性并不意味着彼此相互隐含。

(1) x的一切可能性并不一定都是x的潜力。也许我们通过回忆歌剧中的歌词可以用意大利语说话，但如果我们没有学过意大利语，我们就没有掌握说意大利语的潜力。

(2) x能力所及的并不一定都是x的可能性；即使它们的环境失去了所有水，有些生物仍然具有游泳的潜力。

------

- [ ] ' That is potentially built ' refers to the bricks (and so on).
- [ ] “那个潜在被建造的” 指的是砖块（等等）。
- [ ] The completed house is their complete actuality, and when it is reached, their potentiality to be built is lost .
- [ ] 完成的房屋是它们的完全的实在，当它建成后，它们被建造的潜力也就丧失了。
- [ ] The process of building is their actuality in so far as they are potentially built.
- [ ] 在它们拥有被建造的潜力的情况下，建造的过程成为它们的实在。
- [ ] ' In so far ' picks out the incomplete actuality that is present only as long as the potentiality to be built (lost in the completed house) is still present.
- [ ] “在...范围内”突显了不完整的实在，只要有建造的潜力（在完成的房子中已经消失），这种不完整的实在就会存在。

------

- [ ] Aristotle ' s definition picks out the kind of actuality that is to be identified with change, by appealing to some prior understanding of potentiality and actuality, which in turn rests on an understanding of final causation.
- [ ] 亚里士多德的定义通过呼应对潜力和实在性的先前理解，挑选出表示变化的实在性的种类，这反过来又依赖于对最终原因的理解。
...
神学家将哲学当做神学的工具，神学在哪个时候被视作最高的科学

> 神学，哲学，科学不应该是并列的吗?
>
> 如何理解“神学在哪个时候被视作最高的科学”，比如人类恐惧的经验，形而上的经验，崇拜的经验这类精神性的经验，神学就是将这些超越的精神性的经验进行系统化，所以也可以认为他是一门科学，一门最高的科学。

大致而言，中世纪哲学是一段将理性从信仰中解放出来的过程，这个过程如同自然科学在现代逐渐从哲学中解放出来。

## 中世纪哲学的价值

1 理性服从于信念；

> 其实柏拉图，笛卡尔，斯宾诺莎等唯理论的信徒基本也从一个不能质疑的假设出发，进行逻辑验证。那这种假设其实也是一种信念

2 说教父哲学过于繁杂琐碎，但是当代的分析哲学也是这样过于繁杂琐碎的学问。
...
1 所有的哲学思想必然要受到当时的时代精神所影响，基督教哲学受到宗教影响就像现代的哲学受到科学影响一样。

> 比如政治讲民主，社会讲平等，经济讲自由，在文化上讲多元

2 重点是，对于一个有宗教信仰的人，认为一个命题为真并不同时认为这个命题可以证成为假。**但是这并不表示，如果一个有信仰的哲学家相信一个命题为真，那么他就必须要认定这个命题之所以为真是由哲学理性所证成**

3 事实上，中世纪哲学受到神学主导这件事可以从另外一个角度来看。神学并不主导哲学，**而是哲学家所认定的事实，其基础来自于信念**。

这也说明了为什么一个人在理解前必须要有信念。因为他首先必须接受一个事实之所以被认定为为事实的原因，才能够了解事实为何被认定为事实。并不是说，某样事物为真的理由一定是理性的，这同时也说明为什么不论哲学家的理性说明多么详尽，也无法让人相信这个有理的命题为真【因为最基础来自于信念】

> 不管是奥古斯丁、托马斯的信仰，
>
> 还是笛卡尔、斯宾诺莎、莱布尼茨的真观念和不可动摇的真实，
>
> 其基础都来自于信念【笛卡尔说是自明的】

3 但是，如果某件事物为真，**这就意味着我们相信它为真，就某种程度而言，这就是理性**。

***这就表示说，为真的认定，必然包含信念，而非全然依附在理性论证之上***

这也是中世纪哲学的核心概念，信念必然走在哲学之前，而且哲学只占据了一个重要但次要的位置。

4 第二，如果我们说批判哲学就是康德的哲学的话，那么，很明显的，中世纪哲学就是属于前批判时期。但这并不表示，中世纪哲学家都天真到无法批判自己的立场。他们不认为人的思考可以创造实在，也不认为人的知识范围可以无限延伸。对他们而言，实在论是基本的预设立场。

今天对于我们现代哲学家而言，**怀疑是否有独立于心灵以外的知识依然是一个很重要的假设**，但这也是中世纪哲学家所企图回答的问题之一，因此中世纪哲学家与现代哲学家并没有太大的差别。

5 第三，认为中世纪哲学家把心思都花在极度细微而技术性的问题的观点虽然并没有错误，但我们可以从另一个角度来理解这一点。让我们看看今天的哲学界，依旧是一种学术游戏，由教授以极为细致的语言探讨繁复的问题。因此我们可以说，对中世纪哲学进行这种过度学理化的批判，其实是没有根据的。





**1 中世纪哲学是把所有的超越的经验进行了最好的诠释**

**2 中世界哲学并不特别，他反映了时代精神，这个时代精神就是信仰。**

**3 哲学的基本态度，哲学家从古到今，用批判的态度来检视这个时代的精神，我们通过批判性思维来创造跟别人不一样的想法。这种不一样的想法，让这个社会的思维更多元。大家不会局限于一个固定的教条，这种差异多元的想法慢慢积累到了一定的阶段后，会形成思想上的革命。这个思想上的革命会导致新的阶段产生。**

> 反者道之动.太极动而生阳，动极复静。静而生阴，静极复动。一动一静互为其根。哲学家就是时代精神的反，是预示着新时代的产生。比如笛卡尔相之于中世纪，马克思相对于资本主义社会。比如宋明理学相对于佛道文的海洋。
